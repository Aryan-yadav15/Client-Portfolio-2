...
import { achievements, experience, professionalExperience } from "../lib/myDescription";
    ...
    <div className="relative top-0 z-0 bg-white text-gray-500 px-4 sm:px-10 lg:px-20 py-10 sm:py-20 rounded-[40px] transition-custom-long">
      <div className="flex flex-col">
        <section className="pb-10">
          <h1 className="text-2xl sm:text-4xl lg:text-8xl text-center font-semibold text-black">
            Curriculum Vitae
          </h1>
        ...
        <section className="flex flex-col sm:flex-row gap-4 sm:gap-10">
          <section className="sm:w-1/3">
            <div className="sticky top-5 border-t border-gray-400 pt-5">
              ...
              <h1 className="font-medium text-gray-950 text-5xl ">Education</h1>
            </div>
          </section>
          <section className="sm:w-2/3">
            {experience.map((exp, index) => (
              <div
                key={index}
                className="flex flex-row justify-between py-6 sm:py-10 border-t hover:border-gray-800 transition border-gray-400"
              >
        ...
        <section className="flex flex-col sm:flex-row gap-4 sm:gap-10">
          <section className="sm:w-1/3">
            <div className="sticky top-5 border-t border-gray-400 pt-5">
              ...
              <h1 className="font-medium text-gray-950 text-5xl ">
                Experience
              </h1>
            </div>
          </section>
